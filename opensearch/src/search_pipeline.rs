...
#[doc = "Builder for the [Search Pipeline Delete API](https://opensearch.org/docs/latest/search-plugins/search-pipelines/index/)\n\nDeletes a search pipeline."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Search Pipeline Get API](https://opensearch.org/docs/latest/search-plugins/search-pipelines/retrieving-search-pipeline/)\n\nReturns a search pipeline"]
#[derive(Clone, Debug)]
...
impl<'a> SearchPipeline<'a> {
    ...
    #[doc = "[Search Pipeline Delete API](https://opensearch.org/docs/latest/search-plugins/search-pipelines/index/)\n\nDeletes a search pipeline."]
    pub fn delete<'b>(
        &'a self,
        parts: SearchPipelineDeleteParts<'b>,
    ...
    #[doc = "[Search Pipeline Get API](https://opensearch.org/docs/latest/search-plugins/search-pipelines/retrieving-search-pipeline/)\n\nReturns a search pipeline"]
